...
const Payments = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Fetch transporter IBAN for each car ID
  ...
  const handlePayment = async (deliveryId, delivery, transporter) => {
    const confirmation = window.confirm(
      `Você tem certeza que quer marcar a entrega ${delivery.protocol} como paga?\n\n` +
      `Detalhes da entrega:\n` +
    ...
    try {
      ...
      alert(`Delivery ${deliveryId} has been marked as paid!`);
